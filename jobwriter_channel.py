...
for i in range(1,5):
	with open("conf_channel_strong_" + str(i) + "x" + str(i) + "x" + str(i) + ".xml", "w") as f:
		geo ="     <geometry dim=\"{}\" lengthX=\"5.0\" lengthY=\"1.0\" lengthZ=\"1.0\" sizeX=\"{}\" sizeY=\"{}\" sizeZ=\"{}\">\n".format(dim, 30, 60, 30)
		par ="     <parallel numProcessorsX=\"{}\" numProcessorsY=\"{}\" numProcessorsZ=\"{}\" />\n".format(i,2*i,i)
...
for i in range(1,6):
	with open("conf_channel_strong_" + str(i) + "x" + str(i) + ".xml", "w") as f:
		geo ="     <geometry dim=\"{}\" lengthX=\"5.0\" lengthY=\"1.0\" lengthZ=\"1.0\" sizeX=\"{}\" sizeY=\"{}\" sizeZ=\"{}\">\n".format(dim, 30, 60, 1)
		par ="     <parallel numProcessorsX=\"{}\" numProcessorsY=\"{}\" numProcessorsZ=\"{}\" />\n".format(i,2*i,1)
