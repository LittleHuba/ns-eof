...
struct Triple
{
    ...
    Triple(const Triple<DataType> &other)
    {
        x = other.x;
        y = other.y;
        z = other.z;
    ...
    Triple<DataType> &operator=(const Triple<DataType> &other)
    {
        x = other.x;
        y = other.y;
        z = other.z;
    ...
    template <class DT>
    friend std::ostream& operator<<(std::ostream &os, const Triple<DT> &triple);
    
};

template <class DataType>
std::ostream& operator<<(std::ostream &os, const Triple<DataType> &triple)
{
    os << "{"
       << triple.x << ","
       << triple.y << ","
